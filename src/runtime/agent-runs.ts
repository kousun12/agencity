...
const SDK_GUIDE = [
  ...
  "Use sdk.context.inspect/compact for attributable context-window control; sdk.goals is read-only; sdk.heartbeats and sdk.schedules manage only agent-owned wakes; sdk.agents spawn/list/send/messages/acknowledge/cancel/followUp provides durable nuclear-family messaging; sdk.memory, sdk.harness, sdk.skills, and sdk.specs provide adaptation and delegation.",
  "Use ai.generateText or ai.generateObject only for one provider generation over an explicit prompt or user/assistant messages plus explicitly supplied bounded context. Raw ai calls receive no ambient branch messages, profile, memory retrieval, repository instructions, skills, or tools, and they cannot continue autonomously. Use ordinary TypeScript for deterministic work and sdk.agents.spawn for delegated autonomous work.",
