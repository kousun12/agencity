...
export interface MailboxRecord { readonly mailboxMessageId: string; readonly fromSessionId: string; readonly fromBranchId: string; readonly toSessionId: string; readonly toBranchId: string; readonly kind: MailboxMessageKind; readonly content: string; readonly taskId: string | null; readonly artifactIds: string[]; readonly intentKey: string | null; readonly mode: "steer" | "queue"; readonly legacyFollowUp: boolean; readonly replyToMessageId: string | null; readonly senderRelationship: import("../domain/index.ts").FamilyRelationship | null; readonly receiptStatus: import("../domain/index.ts").MailboxReceiptStatus; readonly delivered: boolean; readonly deliveredToContext: boolean; readonly acknowledged: boolean; readonly contextRunId: string | null; readonly error: string | null; readonly sentAt: string; readonly deliveredAt: string | null; readonly contextDeliveredAt: string | null; readonly acknowledgedAt: string | null; }
export interface TaskTerminalRecoveryStatus {
  readonly taskId: string;
  readonly noticeDelivered: boolean;
  readonly usageAttributed: boolean;
}
...
export interface AgentStorage {
 ...
 getTaskTerminalRecoveryStatus?: (taskId: string) => Promise<TaskTerminalRecoveryStatus | null>;
