...
export const CLI_HELP_GROUPS: readonly CliHelpGroup[] = Object.freeze([
  Object.freeze({
    ...
    commands: Object.freeze([
      ...
      productHelp("agencity refine [status|history|inspect ID|pause|resume|rollback PROPOSAL REASON|--wait|--detach] [--kind KIND[,KIND]] [--scope SCOPE] [INSTRUCTIONS]", "Inspect automatic learning, control future admission, reverse one applied automatic change, or start a detached governed reflection; use ordinary tasks for code or runtime implementation."),
