...
const ADVANCED_OPTIONS: readonly HelpRow[] = Object.freeze([
  ...
  { label: "--started-at ISO  --deadline-at ISO", description: "Retain an external absolute run horizon.", labelTone: "option" },
  { label: "--refinement-review-limit N", description: "Bound explicit refinement reviews during this run.", labelTone: "option" },
  { label: "--refinement-evidence-required N", description: "Require canonical evidence IDs for each bounded review.", labelTone: "option" },
