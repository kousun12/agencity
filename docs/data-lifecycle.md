...
- The current workspace format accepts event schema version 5, reducer version 19, provider input version 1, model dispatch version 2, bounded output version 1, and model effect output version 2.
