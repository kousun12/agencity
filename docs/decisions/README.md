...
ADR 0010 supersedes ADR 0005. When another decision changes, add a new ADR, mark the earlier record `Superseded`, and link both records in this index and in their metadata.
