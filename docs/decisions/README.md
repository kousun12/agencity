...
| [0004](./0004-event-evolution-and-context-references.md) | Event evolution and lossless context references | 2026-08-07 | Proposed | Mixed event versions and referenced context storage | Extends [0001](./0001-durable-local-runtime-foundations.md); not yet implemented or superseded |
| [0005](./0005-typed-autonomous-actions.md) | Typed autonomous actions | 2026-08-07 | Accepted | Model action protocol and executable action boundary | Extends [0001](./0001-durable-local-runtime-foundations.md); not superseded |
| [0006](./0006-durable-agent-relationships.md) | Durable agent relationships | 2026-08-07 | Accepted | Root agents, delegated agents, recursive calls, tasks, and mailboxes | Extends [0001](./0001-durable-local-runtime-foundations.md); not superseded |
...
| [0008](./0008-profile-workspace-and-credentials.md) | Profile, workspace, and credential boundaries | 2026-08-07 | Accepted | Durable identity, ownership, preferences, model selection, and secrets | Extends [0001](./0001-durable-local-runtime-foundations.md); not superseded |
...
No ADR in this catalog currently supersedes another. When a decision changes, add a new ADR, mark the earlier record `Superseded`, and link both records in this index and in their metadata.
