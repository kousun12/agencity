...
Use the naming convention `.x86.:latest` for the image name (e.g. `abc.x86.xyz:latest`), where ` ` is the taskset name and ` ` is the individual task.
