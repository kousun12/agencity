...
- [Prime Verifiers benchmarking plan](./2026-08-10-prime-verifiers-benchmarking-plan.md) — run Agencity as a pinned custom Verifiers v1 harness with OOLONG probes and one bounded Harbor-based Terminal-Bench 2 integration; full-suite, hosted, and harness-comparison claims remain deferred.
