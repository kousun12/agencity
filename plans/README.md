...
- [Prime Verifiers benchmarking plan](./2026-08-10-prime-verifiers-benchmarking-plan.md) — run Agencity as a pinned custom Verifiers v1 harness, beginning with isolated low-cost contract and answer smokes before agentic or ARC-AGI-3 suites.
