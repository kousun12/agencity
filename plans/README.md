...
- [Durable agent profiles and automated refinement review plan](./2026-08-08-adaptive-agent-city-plan.md) — accepted implementation contract with runtime, protocol, terminal controls, lifecycle hardening, and linked-executable governance acceptance implemented; final aggregate verification remains pending, and organization control-plane features remain deferred.
