...
- [Durable agent profiles and automated refinement review plan](./2026-08-08-adaptive-agent-city-plan.md) — accepted implementation contract, in progress, for per-session behavioral profiles and sealed automatic refinement governance; organization control-plane features remain deferred.
