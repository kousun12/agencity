...
- [Default automatic adaptive learning plan](./2026-08-11-default-automatic-adaptive-learning-plan.md) — implementation in progress for default-on device-profile learning, persistent device-wide pause/resume, bounded local triggers including repeated success, and audit-oriented learning history; aggregate verification is pending.
