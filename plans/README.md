...
- [Adaptive agent city plan](./2026-08-08-adaptive-agent-city-plan.md) — define durable per-agent charters, a stable city operator, evolving management hierarchies, and evidence-governed organizational refactoring.
