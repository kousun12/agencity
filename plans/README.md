...
- [Prime Verifiers benchmarking plan](./2026-08-10-prime-verifiers-benchmarking-plan.md) — run Agencity as a pinned custom Verifiers v1 harness with OOLONG probes, bounded Terminal-Bench 2 and 2.1 Harbor integrations, and a split agent/scorer SWE-bench Pro public treatment; full-suite, hosted, and harness-comparison claims remain deferred.
