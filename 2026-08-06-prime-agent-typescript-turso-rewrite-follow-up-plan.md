...
- Commits: `6d552da`, `616a61b`, `713b23e`, `e95cb7f`.
...
- Primary transcript: truthful missing-provider failure without Echo, explicit persisted fixture model, repository coding cells/tools, durable recursive call/result plus retained child follow-up, failed shell completion-gate feedback and repair, distinct JSON result, tree/status/history, named head branch/resume, detach, and resident continuation.
